...
// node_modules/jenesius-vue-modal/dist/jenesius-vue-modal.cjs.js
var require_jenesius_vue_modal_cjs = __commonJS({
  "node_modules/jenesius-vue-modal/dist/jenesius-vue-modal.cjs.js"(exports) {
    ...
    var ModalError = (
      /** @class */
      function(_super) {
        __extends(ModalError2, _super);
        function ModalError2(message, details) {
          if (details === void 0) {
            details = null;
          }
        ...
        ModalError2.Undefined = function(id) {
          return new ModalError2("Modal with id: ".concat(id, " not founded. The modal window may have been closed earlier."));
        };
        ModalError2.UndefinedGuardName = function(name) {
          return new ModalError2("Guard's name ".concat(name, " is not declaration."));
        };
        ModalError2.NextReject = function(id) {
          return new ModalError2("Guard returned false. Modal navigation was stopped. Modal id ".concat(id));
        };
        ModalError2.GuardDeclarationType = function(func) {
          return new ModalError2("Guard's type should be a function. Provided:", func);
        };
        ModalError2.ConfigurationType = function(config2) {
          return new ModalError2("Configuration type must be an Object. Provided", config2);
        };
        ModalError2.ConfigurationUndefinedParam = function(param, availableParams) {
          return new ModalError2("In configuration founded unknown parameter: ".concat(param, ". Available are ").concat(availableParams.join(", "), " "));
        };
        ModalError2.QueueNoEmpty = function() {
          return new ModalError2("Modal's queue is not empty. Probably some modal reject closing by onClose hook.");
        };
        ModalError2.EmptyModalQueue = function() {
          return new ModalError2("Modal queue is empty.");
        };
        ModalError2.NotInitialized = function() {
          return new ModalError2("Modal Container not found. Put container from jenesius-vue-modal in App's template. Check documentation for more information https://modal.jenesius.com/docs.html/installation#getting-started.");
        };
        ModalError2.ModalComponentNotProvided = function() {
          return new ModalError2("The first parameter(VueComponent) was not specified.");
        };
        ModalError2.DuplicatedRouterIntegration = function() {
          return new ModalError2("useModalRouter.init should escaped only once.");
        };
        ModalError2.ModalRouterIntegrationNotInitialized = function() {
          return new ModalError2("The integration was not initialized. Please, use useModalRouter.init(router). For more information: https://modal.jenesius.com/docs.html/integration-vue-router#installation");
        };
        ModalError2.ModalEventNameMustBeString = function(eventName) {
          return new ModalError2("Event name must be a string. Provided: ".concat(eventName));
        };
        return ModalError2;
      }(Error)
    );
    ...
    var guards = {
      ...
      add: function(modalId, name, func) {
        ...
        if (!this.store[modalId])
          this.store[modalId] = (_a = {}, _a[name] = [], _a);
    ...
    function runGuardQueue(guards2) {
      return guards2.reduce(function(promiseAccumulator, guard) {
    ...
    function DtoModalOptions(options) {
      ...
      if (options.backgroundClose !== void 0)
        output.backgroundClose = options.backgroundClose;
      if (options.isRoute)
        output.isRoute = options.isRoute;
      return output;
    }
    var Modal = (
      /** @class */
      function() {
        function Modal2(component, props, options) {
          var _this = this;
          this.events = vue.reactive({});
          this.backgroundClose = true;
          this.isRoute = false;
          this.id = Modal2.modalId++;
        ...
        Object.defineProperty(Modal2.prototype, "onclose", {
          /**
        ...
        Object.defineProperty(Modal2.prototype, "instance", {
          /**
        ...
        Modal2.prototype.on = function(eventName, callback) {
          var _this = this;
        ...
        Modal2.modalId = 0;
        Modal2.EVENT_PROMPT = "jenesius-vue-modal:____P____R____O____M____P____T";
        return Modal2;
      }()
    );
        ...
        return (_ctx, _cache) => {
          return vue.openBlock(), vue.createElementBlock(
            ...
            [(vue.openBlock(), vue.createBlock(
              vue.resolveDynamicComponent(vue.unref(modal).component),
              vue.mergeProps(vue.unref(modal).props.value, {
                class: "modal-item widget__modal-wrap",
                modalId: `_modal_${__props.id}`,
                ref_key: "modalRef",
                ref: modalRef
              }, vue.toHandlers(vue.unref(modal).events)),
              null,
              16,
              ["modalId"]
            ))],
    ...
    var WidgetContainerModalItem = _export_sfc(_sfc_main$1, [["__file", "WidgetModalContainerItem.vue"]]);
    function initialize() {
    ...
    var WidgetModalContainer = _export_sfc(_sfc_main, [["__file", "WidgetModalContainer.vue"]]);
    var state = {
      router: null
    };
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                ...
                if (!(modalRoute && !((_b = (_a = modalRoute.getModalObject()) === null || _a === void 0 ? void 0 : _a.closed) === null || _b === void 0 ? void 0 : _b.value)))
                  return [
                    3,
                    2
                  ];
              ...
              case 0:
                ...
                return [
                  ...
                  openModal(component, vue.computed(function() {
                    var _a2;
                    return (_a2 = state.router) === null || _a2 === void 0 ? void 0 : _a2.currentRoute.value.params;
                  }), {
                    isRoute: true
                  })
                ];
              case 1:
                ...
                modal.onclose = function() {
                  ...
                  if (!isNavigationClosingGuard)
                    (_a2 = state.router) === null || _a2 === void 0 ? void 0 : _a2.back();
                };
                return [
                  2
                  /*return*/
...
export default require_jenesius_vue_modal_cjs();
/*! Bundled license information:

jenesius-vue-modal/dist/jenesius-vue-modal.cjs.js:
  (*!
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=jenesius-vue-modal.js.map
